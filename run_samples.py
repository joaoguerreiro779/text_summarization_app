...
def get_rouge_score():
    ...
    """
    Summarize some BBC News articles and compute
    their rouge-1, rouge-2 and rouge-l scores.
    """
    ...
    print(
        "Mean Rouge-N1 Precision: "
        + str(sum(r1_precision_list) / len(r1_precision_list))
    )
    ...
    print(
        "Mean Rouge-N2 Precision: "
        + str(sum(r2_precision_list) / len(r1_precision_list))
    )
