...
class LanguageIdentifier(ABC):
    ...
    def get_language(self, query_text: str) -> Tuple[str, float]:
        ...
        Get the language of an input text.
            ...
            Parameters:
                    query_text (str): Input text for language to be detected.

            Returns:
                    result.language (str): Language code of the input text.
                    result.probability (str): Probability output of the model.
        """
